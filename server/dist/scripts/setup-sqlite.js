...
async function setupSQLiteDatabase() {
    ...
    `, [
        ...
        const systemManagerPassword = await bcryptjs_1.default.hash('EliteAdmin2024!', 12);
        await (0, sqlite_database_1.query)(`
    ...
    `, [
        ...
        const branchManagerPassword = await bcryptjs_1.default.hash('EliteManager2024!', 12);
        await (0, sqlite_database_1.query)(`
      INSERT OR REPLACE INTO users (
        id, tenant_id, email, password_hash, first_name, last_name,
    ...
    `, [
        ...
        await (0, sqlite_database_1.query)('UPDATE branches SET manager_id = ? WHERE id = ?', [branchManagerId, branchId]);
        const coaches = [
        ...
        for (const coach of coaches) {
            ...
            const password = await bcryptjs_1.default.hash('EliteCoach2024!', 12);
            await (0, sqlite_database_1.query)(`
        INSERT OR REPLACE INTO users (
          id, tenant_id, email, password_hash, first_name, last_name,
          phone, role, status, branch_id, email_verified
      ...
      `, [
        ...
        for (const student of studentData) {
            ...
            const password = await bcryptjs_1.default.hash('EliteStudent2024!', 12);
            await (0, sqlite_database_1.query)(`
        INSERT OR REPLACE INTO users (
          id, tenant_id, email, password_hash, first_name, last_name,
          phone, role, status, branch_id, email_verified
...
exports.default = setupSQLiteDatabase;
//# sourceMappingURL=setup-sqlite.js.map